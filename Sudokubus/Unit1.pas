...
uses
  ...
  StdCtrls, ExtCtrls, Menus, Buttons, ComCtrls, RxGif, XPMan;
...
begin
    ...
    bitmap.canvas.draw(b2,h2,Image1.picture.bitmap);
...
begin
    ...
    jetzt:=random(3)+1;
    for i:=1 to 27 do
      loesung2:=loesung2+inttostr(reihe[strtoint(loesung[jetzt][i])]);
...
begin
    ...
    test(ebene9);
    if korrekt then
      showmessage('Congratulations! The Sudoku puzzle has been solved..');
end;
