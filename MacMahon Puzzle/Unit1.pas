...
uses
  ...
  Buttons, StdCtrls, ExtCtrls, XPMan, Dialogs;
...
procedure TForm1.R1C(Sender: TObject);
var
  f:integer;
begin
  f:=clred;
...
procedure TForm1.R3C(Sender: TObject);
begin
  p1.Color:=clred;
  p2.Color:=clyellow;
  p3.Color:=clred;
