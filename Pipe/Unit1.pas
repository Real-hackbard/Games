...
uses
  ...
  ExtCtrls, Menus, StdCtrls, ComCtrls, Buttons, Spin, XPMan;
...
var
  breite,hoehe,i,j,xoffset,yoffset:integer;
  bitmap:tbitmap;
  ziel:tcanvas;
  kk,k:string;
  geschafft:boolean;
...
begin
    ...
    if geschafft then begin
      ...
      showmessage('Congratulations! The game level has been completed.');
    end;
    PaintBox1.canvas.draw(0,0,bitmap);
    bitmap.free;
end;
...
procedure TForm1.PaintBox1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  b,h,i,j,xoffset,yoffset,nrx,nry:integer;
begin
    b:=PaintBox1.width;
    h:=PaintBox1.height;
...
procedure TForm1.PaintBox1MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
var
  b,h,xoffset,yoffset,nrx,nry:integer;
begin
